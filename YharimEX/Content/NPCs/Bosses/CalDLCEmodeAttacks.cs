...
namespace InfernalEclipseAPI.YharimEX.Content.NPCs.Bosses
{
    public class CalDLCEmodeAttacks : CalDLCEmodeAttacksBase
    {
        ...
        {
            return CalamityWorld.death || WorldSaveSystem.InfernumModeEnabled || InfernalWorld.RagnarokModeEnabled ? base.NewInstance(target) : null;
        }
        ...
        public override bool SafePreAI(NPC npc)
        {
            ...
            bool Phase2Check()
            {
                ...
                if (Main.expertMode && npc.life < npc.lifeMax / 2)
                {
                    ...
                    if (YharimEXUtils.HostCheck)
                    {
                        ...
                        npc.ai[3] = 0;
                        npc.netUpdate = true;
                        YharimEXUtils.ClearHostileProjectiles(1, npc.whoAmI);
            ...
            void ChooseNextAttack(params int[] args)
            {
                ...
                if (YharimEXUtils.HostCheck)
                {
                    int maxMemory = WorldSaveSystem.InfernumModeEnabled ? 10 : 16;
                ...
                mutantBoss.endTimeVariance = WorldSaveSystem.InfernumModeEnabled ? Main.rand.NextFloat() : 0;
                ...
                if (npc.ai[1] == fishronDelay * maxFishronSets + 35)
                {
                    ...
                    if (YharimEXUtils.HostCheck)
                    {
                        for (int j = -1; j <= 1; j += 2) //to both sides of player
                        {
                            ...
                            Projectile.NewProjectile(npc.GetSource_FromThis(), npc.Center, Vector2.Zero, ModContent.ProjectileType<YharimEXOldDuke>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage), 0f, Main.myPlayer, offset.X, offset.Y);
                        }
                    }
                }
            }
            void CalamityMechRayFan()
            {
                ...
                int startTime = WorldSaveSystem.InfernumModeEnabled ? 90 * 2 : 90;
                if (timer % 90 == 0 && timer > startTime)
                {
                    ...
                    if (YharimEXUtils.HostCheck)
                    {
                        ...
                        Projectile.NewProjectile(npc.GetSource_FromThis(), pos, vel, ModContent.ProjectileType<YharimEXPBG>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage), 0f, Main.myPlayer);
                    }
                }
            }
            #endregion
            ...
            void CryogenP1()
            {
                ...
                if (--Timer < 0)
                {
                    ...
                    else
                    {
                        ...
                        {
                            int p = Projectile.NewProjectile(npc.GetSource_FromAI(), npc.Center, velocity, ModContent.ProjectileType<IceBomb>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage), 0f, Main.myPlayer, 0f, 0f, 0f);
            ...
            void BumbleDrift()
            {
                ...
                if (Timer == WindupTime)
                {
                    ...
                    if (YharimEXUtils.HostCheck)
                        Projectile.NewProjectile(npc.GetSource_FromThis(), npc.Center, Vector2.Zero, ModContent.ProjectileType<DLCYharimSpearSpin>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage), 0f, Main.myPlayer, npc.whoAmI, DriftTime);
                }
            ...
            void BumbleDash()
            {
                ...
                if (Timer == 1)
                {
                    if (YharimEXUtils.HostCheck)
                    {
                        Projectile.NewProjectile(npc.GetSource_FromThis(), npc.Center, Vector2.Zero, ModContent.ProjectileType<DLCYharimSpearDash>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage), 0f, Main.myPlayer, npc.whoAmI);
                    }
                }
                if (Timer < WindupTime)
                {
            ...
            void PrepareAresNuke()
            {
                ...
                */
                ...
                {
                    YharimEXBoss mutantBoss = npc.ModNPC as YharimEXBoss;
                    Vector2 pos = YharimEXUtils.ProjectileExists(mutantBoss.ritualProj, ModContent.ProjectileType<YharimEXRitual>()) == null ? npc.Center : Main.projectile[mutantBoss.ritualProj].Center;
                    ...
                    {
                        Vector2 dir = (npc.Center - pos).SafeNormalize(Vector2.UnitY.RotatedByRandom(MathHelper.TwoPi));
                    ...
                    if (YharimEXUtils.HostCheck)
                    {
                        ...
                        if (!Main.projectile.Any(p => p != null && p.active && p.type == ritual))
                            Projectile.NewProjectile(npc.GetSource_FromThis(), npc.Center, Vector2.Zero, ritual, YharimEXUtils.ScaledProjectileDamage(npc.defDamage, 4f / 3f), 0f, Main.myPlayer, npc.whoAmI);
                        int nuke = Projectile.NewProjectile(npc.GetSource_FromThis(), npc.Center, distance, ModContent.ProjectileType<YharimEXAresNuke>(), WorldSaveSystem.InfernumModeEnabled ? YharimEXUtils.ScaledProjectileDamage(npc.defDamage, 4f / 3f) : 0, 0f, Main.myPlayer, gravity);
                ...
                */
                ...
                if (YharimEXUtils.HostCheck)
                {
                    ...
                    for (int i = 0; i < 3; i++)
                    {
                        ...
                        Projectile.NewProjectile(npc.GetSource_FromThis(), spawnPos, Vector2.Zero, ModContent.ProjectileType<YharimEXAresBomb>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage, 4f / 3f), 0f, Main.myPlayer);
                    }
                }
                ...
                if (++Timer > (Counter > 2 ? 80 : 30))
                {
                    if (++Counter > 3)
                    {
                        ChooseNextAttack(11, 13, 16, 19, 24, WorldSaveSystem.InfernumModeEnabled ? 26 : 29, 31, 35, 37, 39, 41, 42);
                        Counter = 0;
                        DLCAttackChoice = DLCAttack.None;
                    }
                    else
                ...
                if (Timer == 30 + Windup)
                {
                    ...
                    if (YharimEXUtils.HostCheck)
                    {
                        ...
                        for (int i = -8; i < 2; i++)
                        {
                            ...
                            Projectile.NewProjectile(npc.GetSource_FromThis(), npc.Center, speedX * Vector2.UnitX + speedY * Vector2.UnitY, ModContent.ProjectileType<YharimEXSlimeGod>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage, 1f), 1f, Main.myPlayer, crimson);
                        }

                        float speed = 8;
                        Vector2 aureusVel = Vector2.Normalize(Vector2.UnitX * -Math.Sign(player.Center.X - npc.Center.X) + Vector2.UnitY) * speed;
                        Projectile.NewProjectile(npc.GetSource_FromThis(), npc.Center, aureusVel, ModContent.ProjectileType<YharimEXAureusSpawn>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage, 1f), 1f, Main.myPlayer, player.whoAmI);
                    }
            ...
            void Calamitas()
            {
                ...
                if (Timer == Startup)
                {
                    if (YharimEXUtils.HostCheck)
                    {
                        YharimEXBoss mutantBoss = npc.ModNPC as YharimEXBoss;
                        Vector2 pos = YharimEXUtils.ProjectileExists(mutantBoss.ritualProj, ModContent.ProjectileType<YharimEXRitual>()) == null ? npc.Center : Main.projectile[mutantBoss.ritualProj].Center;
                        Vector2 rot = player.velocity.SafeNormalize(Vector2.UnitY);
                        const int moons = 7;
                        for (int i = 0; i < moons; i++)
                        {
                            Vector2 offset = rot.RotatedBy(i * MathHelper.TwoPi / moons);
                            Vector2 targetPos = pos + offset * 1450f;
                            Projectile.NewProjectile(npc.GetSource_FromAI(), targetPos, targetPos.DirectionTo(player.Center), brimstoneMonster, YharimEXUtils.ScaledProjectileDamage(npc.defDamage, 4f / 3f), 0f, Main.myPlayer, 0f, 2f, 0f);
                        }
                ...
                if (Timer > Startup)
                {
                    Vector2 dir = (npc.Center - player.Center).SafeNormalize(-Vector2.UnitY);
                    ...
                    if ((Timer - Startup) % CalamitasTime == CalamitasTime - 1)
                    {
                        if (YharimEXUtils.HostCheck)
                        {
                            ...
                            for (int i = 0; i < calamiti; i++)
                            {
                                ...
                                Projectile.NewProjectile(npc.GetSource_FromAI(), spawnPos, aim, ModContent.ProjectileType<YharimEXSCal>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage, 4f / 3f), 0f, Main.myPlayer, TelegraphTime);
                            }
                        }
                    }
                    if (Timer > Startup + (CalamitasTime * (Attacks + 1) - 10))
                    {
                        ...
                        foreach (Projectile projectile in Main.projectile.Where(p => p != null && p.active && p.type == brimstoneMonster))
                        {
                            ...
                            for (int i = 0; i < 30; i++)
                            {
                                ...
                                Dust.NewDust(pos, 1, 1, DustID.LifeDrain, 0f, 0f, 100, default, 2f);
                            }
                            projectile.Kill();
                        }
            ...
            void BumbleDrift2()
            {
                ...
                {
                    if (YharimEXUtils.HostCheck)
                        Projectile.NewProjectile(npc.GetSource_FromThis(), npc.Center, Vector2.Zero, ModContent.ProjectileType<DLCYharimSpearSpin>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage), 0f, Main.myPlayer, npc.whoAmI, WindupTime - StartupTimeOtherwiseItKindaTelefragsYouSometimes);
                }
            ...
            void BumbleDash2()
            {
                ...
                if (Timer > WindupTime && Timer % 6 == 0 && YharimEXUtils.HostCheck)
                {
                    Projectile.NewProjectile(npc.GetSource_FromThis(), npc.Center, -Vector2.Normalize(npc.velocity).RotatedByRandom(MathHelper.PiOver4), ModContent.ProjectileType<FrostMist>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage), 0f, Main.myPlayer, ai1: 55);
                }
            ...
            void Providence()
            {
                ...
                {
                    YharimEXBoss mutantBoss = npc.ModNPC as YharimEXBoss;
                    Projectile arena = YharimEXUtils.ProjectileExists(mutantBoss.ritualProj, ModContent.ProjectileType<YharimEXRitual>());
                    if (arena != null)
                    {
                ...
                else if (Timer - PrepareTime < DashTime)
                {
                    ...
                    if (Timer % 3 == 0)
                    {
                        if (YharimEXUtils.HostCheck)
                        {
                            ...
                            Projectile.NewProjectile(npc.GetSource_FromAI(), npc.Center, spearVel, ModContent.ProjectileType<HolySpear>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage), 0f, Main.myPlayer, 1f, 0f, 0f);
                        }
                    }
                }
                ...
                else if (Timer - PrepareTime - DashTime == LaserPrepareTime)
                {
                    ...
                    if (YharimEXUtils.HostCheck)
                    {
                        ...
                        velocity2 = velocity2.RotatedBy((0.0 - (double)beamDirection) * 6.2831854820251465 / 6.0, default);
                        Projectile.NewProjectile(npc.GetSource_FromAI(), npc.Center.X, npc.Center.Y, velocity2.X, velocity2.Y, ModContent.ProjectileType<YharimEXHolyRay>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage, 3f / 2), 0f, Main.myPlayer, beamDirection * ((float)Math.PI * 2f) / rotation, npc.whoAmI, 0f);
                        Projectile.NewProjectile(npc.GetSource_FromAI(), npc.Center.X, npc.Center.Y, 0f - velocity2.X, 0f - velocity2.Y, ModContent.ProjectileType<YharimEXHolyRay>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage, 3f / 2), 0f, Main.myPlayer, (0f - beamDirection) * ((float)Math.PI * 2f) / rotation, npc.whoAmI, 0f);
                    }
                    npc.netUpdate = true;
                }
                else
                {
                    ...
                    {
                        Reset();
                        ChooseNextAttack(11, 16, 19, 20, WorldSaveSystem.InfernumModeEnabled ? 44 : 26, 31, 33, 35, 42, 44, 45);
                        return;
                    }
                }
                Timer++;
            ...
            void YharonBH()
            {
                ...
                {
                    SoundEngine.PlaySound(SoundID.Item20, npc.Center, null);
                    if (!YharimEXUtils.HostCheck)
                    {
                        return;
                    }
                    ...
                    switch (attackType)
                    {
                        case 0:
                            {
                                ...
                                for (int i = 0; i < totalProjectiles; i++)
                                {
                                    ...
                                    {
                                        Projectile.NewProjectile(npc.GetSource_FromAI(), npc.Center, npc.velocity, ModContent.ProjectileType<FlareDust>(), projectileDamage, 0f, Main.myPlayer, ai0, i * offsetAngle, 0f);
                                    }
                                }
                                break;
                            }
                        case 1:
                            {
                                double radians = (float)Math.PI * 2f / totalProjectiles;
                                Vector2 spinningPoint = Vector2.Normalize(new Vector2(0f - npc.localAI[2], 0f - projectileVelocity));
                                for (int j = 0; j < totalProjectiles; j++)
                                {
                                    Vector2 vector2 = spinningPoint.RotatedBy(radians * j, default) * projectileVelocity;
                                ...
                                float newRadialOffset = (int)aiVariableUsed / (timer / 4) % 2f == 0f ? radialOffset : 0f - radialOffset;
                ...
                if (Timer == WindupTime)
                {
                    ...
                    if (Main.netMode != NetmodeID.MultiplayerClient)
                    {
                        Projectile.NewProjectile(npc.GetSource_FromAI(), npc.Center, Vector2.Zero, type, YharimEXUtils.ScaledProjectileDamage(npc.defDamage), 0f, Main.myPlayer, bhTime, npc.whoAmI, 0f);
                    }
                ...
                if (Timer > WindupTime && Timer <= WindupTime + bhTime)
                {
                    ...
                    int totalProjectiles = WorldSaveSystem.InfernumModeEnabled ? 36 : 30;
                    if (Timer % flareDustSpawnDivisor == 0)
                    {
                        DoFlareDustBulletHell(0, flareDustSpawnDivisor, YharimEXUtils.ScaledProjectileDamage(npc.defDamage), totalProjectiles, 0f, 0f, phase2: true);
                    }
                ...
                if (++npc.ai[1] > 60)
                {
                    ...
                    else
                    {
                        ...
                        if (YharimEXUtils.HostCheck) //spawn worm
                        {
                            ...
                            if (WorldSaveSystem.InfernumModeEnabled)
                                ai1 += 0.4f;
                            int current = Projectile.NewProjectile(npc.GetSource_FromThis(), npc.Center, vel, ModContent.ProjectileType<YharimEXDoGHead>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage), 0f, Main.myPlayer, npc.target, ai1);
                            ...
                            for (int i = 0; i < max; i++)
                                current = Projectile.NewProjectile(npc.GetSource_FromThis(), npc.Center, vel, ModContent.ProjectileType<YharimEXDoGBody>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage), 0f, Main.myPlayer, Main.projectile[current].identity);
                            int previous = current;
                            current = Projectile.NewProjectile(npc.GetSource_FromThis(), npc.Center, vel, ModContent.ProjectileType<YharimEXDoGTail>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage), 0f, Main.myPlayer, Main.projectile[current].identity);
            ...
            void Polterghast()
            {
                ...
                if (Timer % PolterTime == PolterTime / 2)
                {
                    ...
                    if (YharimEXUtils.HostCheck)
                    {
                        ...
                        {
                            Vector2 spawnDir = npc.ai[3].ToRotationVector2().RotatedBy(MathHelper.TwoPi * i / Polters);
                            Vector2 spawnPos = player.Center + spawnDir * YharimEXPolter.StartDistance;
                            Vector2 targetPos = player.Center;
                            Projectile.NewProjectile(npc.GetSource_FromThis(), spawnPos, Vector2.Zero, ModContent.ProjectileType<YharimEXPolter>(), YharimEXUtils.ScaledProjectileDamage(npc.defDamage), 0f, Main.myPlayer, targetPos.X, targetPos.Y, Counter);
                        }
                    }
                    Counter = -Counter;
                    npc.ai[3] = Main.rand.NextFloat(MathHelper.TwoPi);
                ...
                {
                    ChooseNextAttack(11, 13, 16, 21, WorldSaveSystem.InfernumModeEnabled ? 26 : 24, 29, 31, 35, 37, 39, 41, 45);
                    Reset();
                    return;
                }
                Timer++;
