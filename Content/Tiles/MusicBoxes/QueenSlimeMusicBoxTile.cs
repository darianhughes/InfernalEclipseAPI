...
{
    public class QueenSlimeMusicBoxTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(191, 142, 111), this.CreateMapEntryName());
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            localPlayer.cursorItemIconID = ModContent.ItemType<QueenSlimeMusicBox>();
        }
