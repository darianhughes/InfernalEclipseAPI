...
{
    public class TerraBladeRelicTile : ModTile
    {
        ...
        public virtual string RelicTextureName => "InfernalEclipseAPI/Content/Tiles/Relics/TerraBladeRelicTile";
        public virtual string ColoredRelicTextureName => "InfernalEclipseAPI/Content/Tiles/Relics/TerraBladeRelicColoredTile";
