...
{
    public class EyeMusicBoxTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            this.AddMapEntry(new Color(191, 142, 111), ((ModBlockType)this).CreateMapEntryName());
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            localPlayer.cursorItemIconID = ModContent.ItemType<EyeMusicBox>();
        }
