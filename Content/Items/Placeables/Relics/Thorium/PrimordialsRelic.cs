...
namespace InfernalEclipseAPI.Content.Items.Placeables.Relics.Thorium
{
    public class PrimordialsRelic : BaseRelicItem
    {
        ...
        public override Color? PersonalMessageColor => Color.MediumVioletRed;

        public override string PersonalMessage => Language.GetTextValue("Mods.InfernalEclipseAPI.ItemTooltip.PrimordialsRelic");
