...
namespace InfernalEclipseAPI.Content.Items.Placeables.Relics.SOTS
{
    public class PutridPinkyRelic : BaseRelicItem
    {
        ...
        public override Color? PersonalMessageColor => Color.HotPink;

        public override string PersonalMessage => Language.GetTextValue("Mods.InfernalEclipseAPI.ItemTooltip.PutridRelic");
