...
namespace InfernalEclipseAPI.Content.Items.Placeables.Relics.Consolaria
{
    public class TurkorTheUngratefulRelic : BaseRelicItem
    {
        ...
        public override Color? PersonalMessageColor => Color.DarkSalmon;

        public override string PersonalMessage => Language.GetTextValue("Mods.InfernalEclipseAPI.ItemTooltip.TurkorRelic");
