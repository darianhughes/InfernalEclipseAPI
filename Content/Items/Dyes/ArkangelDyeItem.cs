...
{
    public class ArkangelDyeItem : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            GameShaders.Armor.BindShader(Type, new ArmorShaderData(Mod.Assets.Request<Effect>("Assets/Effects/ArkangelDye"), "ArkangelDyePass"));
        }
