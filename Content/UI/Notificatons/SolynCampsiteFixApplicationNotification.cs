...
{
    public class SolynCampsiteFixApplicationNotification : IInGameNotification
    {
        ...
        public void DrawInGame(SpriteBatch spriteBatch, Vector2 bottomAnchorPosition)
        {
            ...
            string title = Language.GetTextValue("Mods.InfernalEclipseAPI.UI.DevNoticeCampsiteFix");
