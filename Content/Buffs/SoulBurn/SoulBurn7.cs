...
{
    public class SoulBurn7 : ModBuff
    {
        ...
        internal static void DrawEffects(NPC npc, ref Color drawColor)
        {
            ...
            Vector2 npcSize = ((Entity)npc).Center + new Vector2(Utils.NextFloat(Main.rand, (float)(-((Entity)npc).width / 2), (float)(((Entity)npc).width / 2)), Utils.NextFloat(Main.rand, (float)(-((Entity)npc).height / 2), (float)(((Entity)npc).height / 2)));
