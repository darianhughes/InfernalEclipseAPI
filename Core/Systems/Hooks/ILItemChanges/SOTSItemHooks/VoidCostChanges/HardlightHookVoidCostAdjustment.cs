...
{
    public class HardlightHookVoidCostAdjustment : ModSystem
    {
        ...
        public override void Load()
        {
            ...
            var t = sots.Code?.GetType("SOTS.Items.Invidia.HardlightHook");
            if (t == null) return;
            ...
            _getVoidHook = new Hook(mi, (GetVoidDelegate)((self, player) => 25));
        }
