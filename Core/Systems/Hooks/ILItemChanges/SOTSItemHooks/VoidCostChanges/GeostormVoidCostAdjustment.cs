...
{
    public class GeostormVoidCostAdjustment : ModSystem
    {
        ...
        public override void Load()
        {
            ...
            var t = sots.Code?.GetType("SOTS.Items.Earth.Geostorm");
            if (t == null) return;

            var mi = t.GetMethod("GetVoid", BindingFlags.Instance | BindingFlags.Public);
            if (mi == null) return;

            _getVoidHook = new Hook(mi, (GetVoidDelegate)((self, player) => 8));
        }
